            ...
            return '<td class="text-center">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <button class="dropdown-item" data-bs-target="#update" data-id="'.$row['id'].'" data-name="'.$row['name'].'" data-description="'.$row['description'].'" data-bs-toggle="modal">Update</button>
