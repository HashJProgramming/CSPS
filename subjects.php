        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        <div class="form-floating mb-3"><input class="form-control form-control" type="text" placeholder="name@example.com" name="fullname"><label class="form-label" for="floatingInput">SUBJECT&nbsp;NAME</label></div>
